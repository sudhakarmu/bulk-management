            ...
            <div class="adv-table">
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                ...
                <?php
                  ...
                  $query = "SELECT * FROM users WHERE status=0 AND usertype='owner'";
                  $result = mysqli_query($con,$query);
                ?>
        <tbody>
                  <?php 
                  ...
                  <tr>
                    ...
                    <td><a href="seller.php?accept=<?php echo $row['id']; ?>" class="btn btn-success">Accept</a></td>
                    <td><a href="seller.php?reject=<?php echo $row['id']; ?>" class="btn btn-danger">Reject</a></td>
                  </tr>
                                      <?php 
                        }
                    }
