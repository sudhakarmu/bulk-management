          ...
          <aside class="mid-side">
            ...
            <?php
                  ...
                  if($_SESSION['ROLE']=="admin"){
                    $query = "SELECT * FROM orders WHERE order_status='Accepted'";
                  }
                  if($_SESSION['ROLE']=="owner"){
                      $name = $_SESSION['name'];
                    $query = "SELECT * FROM orders WHERE order_status='Accepted' AND `bulk_name`='$name'";
                  }
            ...
            <div class="room-desk">
              ...
              <div class="room-box">
                ...
                <p><span class="text-muted">Assigned :</span> <?php echo $row['bulk_name']; ?> </p>
